...
VALUES (2,1,CURRENT_TIMESTAMP,'AXDV-C1 METERING VALVE','C1',1500.15,'AVAILABLE', 10);
INSERT INTO products (id, categories_id,created_at,description,name,price,status,stock)
VALUES (3,1,CURRENT_TIMESTAMP,'AXDV-C2 METERING VALVE','C2',1500.15,'AVAILABLE', 10);
INSERT INTO products (id, categories_id,created_at,description,name,price,status,stock)
VALUES (4,2,CURRENT_TIMESTAMP,'FTMO-A5','FTMO',40,'AVAILABLE', 5);